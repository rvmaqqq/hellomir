...
@loader.tds
class TrollingMod(loader.Module):
    """Awasome trolling module"""
    ...
    strings_ru = {
        ...
        "_cmd_doc_ana3": "В разработке",
        "_cmd_doc_ana1": "В разработке",
        "_cmd_doc_anakonda": "+ секунды + шапка",
        "_cmd_doc_ana2": "<reply to file> - В разработке",
        "_cls_doc": "Самый ебейший тролль модуль",
    }
    ...
    strings_de = {
        ...
        "_cmd_doc_ana2": "Datenbank aus Datei wiederherstellen",
        "_cmd_doc_backupmods": "Backup-Module erstellen",
        "_cmd_doc_aan7": "<reply to file> - Module aus Datei wiederherstellen",
    ...
    async def destroychatcmd(self, message: Message):
        """destroyedchat"""
        reply = await message.get_reply_message()
        if not reply or not reply.media:
